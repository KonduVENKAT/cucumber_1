...
public class StepDefintion_UberBookingCar {
	...
	public void user_wants_book_a_car_type_like_from_uber_app(String carType) {
			  System.out.println("Step - 1 : "+carType);
						...
						// cucumber - expression Not regular Expression {String }, {integer} etc...
	// automatically step method will be created with this cucumber Expression format method generated  
